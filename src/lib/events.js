...
export const events = [
  ...
  },
  {
    ...
    description: "Something a little different this month. Kit brings his live dating podcast, Stay Slick, to Mason & Fifth in Westbourne Park — joined by theCollective founder, Mel Labiran, for a night of real stories, real questions, and real connection. Expect candid conversation, a few laughs, and an audience just as curious as you are. It's Kit's second show, and this one's building on the last. Pull up a seat, bring a friend, and see where the conversation goes. If you're intrigued, we'd love to have you there.",
    ctaLabel: 'Register Interest',
  ...
  },
  {
    ...
    description: 'A refined evening in the heart of Mayfair, hosted in partnership with theCOLLECTIVE. Join Ariyani for an intimate gathering of considered detail and quiet luxury — an evening curated for those who appreciate the finer things.',
    ctaLabel: 'Book',
