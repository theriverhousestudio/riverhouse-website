...
export const events = [
  ...
  },
  {
    ...
    description: "Something a little different this month. Kit brings his live dating podcast, Stay Slick, to Mason & Fifth in Westbourne Park. He's joined by theCollective founder, Mel Labiran, for a night of real stories and real conversation. Expect candid chat, a few laughs, and a curious crowd. It's Kit's second show, building on the last. Pull up a seat, bring a friend — if you're intrigued, we'd love to have you there.",
    ctaLabel: 'Register Interest',
